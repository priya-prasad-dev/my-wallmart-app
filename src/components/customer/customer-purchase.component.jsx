...
const CustomerPurchase = () => {
  ...
  const handleSubmit = async () => {
    ...
    const customer_req_info = await contract.methods.requestByCustomer(mydata._customerRequestID).call();
    console.log("full_prdct_info",product_info);
    console.log("amnt_per_unit",product_info.sellingPrice)
    console.log("customer_req_info",customer_req_info.quantity);
    const productCost = product_info.sellingPrice * customer_req_info.quantity;
